...
$root = rtrim($_SERVER['DOCUMENT_ROOT'].'/family_planning',''); // don't touch this configuration
...
$base_url="http://arenaphone.us/family_planning"; //url base of site if you want only relative url leave empty
$upload_dir = '/upload_images/content_images'; // path from base_url to upload base dir
$current_path = '../../../../../upload_images/content_images/'; // relative path from filemanager folder to upload files folder
